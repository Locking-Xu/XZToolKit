...
@interface XZAddressBookViewController (){
...
- (void)viewDidLoad {
    ...
    _contactDic = [[XZAddressBookHelper shareInstance] getAddressBookWithProperties:@[FullName,FirstNameFirstLetter]];
    
    XZObjectLog(_contactDic);
